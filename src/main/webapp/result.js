$(document).ready(function() {
  ...
  var weatherUrl = `https://api.apixu.com/v1/forecast.json?key=${weatherKey}&q=${cityName}&days=6`;
  ...
  fetch(weatherUrl, {
    ...
    .then(function(response) {
      ...
      for (element of response.forecast.forecastday) {
        ...
        $("#weatherSection > .resultTitle").text(`Weather forecast of ${cityName} in this week`);
